...
// fujicoin includes.
#include <..\src\script\fujicoinconsensus.h>
...
int main()
{
    std::cout << "fujicoinconsensus version: " << fujicoinconsensus_version() << std::endl;
    ...
    auto op0Result = fujicoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, fujicoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
