...
make -C depends --jobs="$JOBS" HOST="$HOST" \
                                   ...
                                   qt_config_opts_i686_linux='-platform linux-g++ -xplatform fujicoin-linux-g++' \
                                   qt_config_opts_x86_64_linux='-platform linux-g++ -xplatform fujicoin-linux-g++' \
...
# CONFIGFLAGS
CONFIGFLAGS="--enable-reduce-exports --disable-bench --disable-tests --disable-gui-tests --disable-fuzz-binary"
case "$HOST" in
