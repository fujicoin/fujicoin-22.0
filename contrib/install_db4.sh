...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the fujicoin repository."
  exit 1
fi
...
# See https://github.com/fujicoin/fujicoin/issues/16064
...
echo 'When compiling fujicoind, run `./configure` in the following way:'
echo
