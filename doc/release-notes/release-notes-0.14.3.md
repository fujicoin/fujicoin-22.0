Fujicoin Core version *0.14.3* is now available from:

  <https://fujicoin.org/bin/fujicoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/fujicoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
