...
Fujicoin Core version 0.21.0 is now available from:

  <https://fujicoincore.org/bin/fujicoin-core-0.21.0/>
...
- This release adds support for Tor version 3 hidden services, and rumoring them
  ...
  [BIP155](https://github.com/fujicoin/bips/blob/master/bip-0155.mediawiki).
...
- This release adds support for serving
  [BIP157](https://github.com/fujicoin/bips/blob/master/bip-0157.mediawiki) compact
...
- This release adds support for signets
  ([BIP325](https://github.com/fujicoin/bips/blob/master/bip-0325.mediawiki)) in
...
- This release implements
  [BIP339](https://github.com/fujicoin/bips/blob/master/bip-0339.mediawiki)
...
- This release implements the proposed Taproot consensus rules
  ([BIP341](https://github.com/fujicoin/bips/blob/master/bip-0341.mediawiki) and
  [BIP342](https://github.com/fujicoin/bips/blob/master/bip-0342.mediawiki)),
...
- #19284 Add seed.fujicoin.wiz.biz to DNS seeds (wiz)
...
- #20198 Show name, format and if uses descriptors in fujicoin-wallet tool (jonasschnelli)
...
- #19133 rpc, cli, test: add fujicoin-cli -generate command (jonatack)
...
- #20055 Set HTTP Content-Type in fujicoin-cli (laanwj)
...
### Build system
- #18504 Drop fujicoin-tx and fujicoin-wallet dependencies on libevent (ryanofsky)
...
- #18297 Use pkg-config in FUJICOIN_QT_CONFIGURE for all hosts including Windows (hebasto)
...
- #18653 add coverage for fujicoin-cli -rpcwait (jonatack)
...
- #18739 Document how to fuzz Fujicoin Core using Honggfuzz (practicalswift)
...
- #19061 Add link to Visual Studio build readme (maitrefujicoin)
...
- #18817 Document differences in fujicoind and fujicoin-qt locale handling (practicalswift)
