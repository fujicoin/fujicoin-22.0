...
Fujicoin Core version 0.21.1 is now available from:
  ...
  <https://fujicoincore.org/bin/fujicoin-core-0.21.1/>
...
FAQ](https://fujicoincore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/fujicoin/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/fujicoin/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/fujicoin/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Fujicoin](https://fujicoinmagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-fujicoin)
  - [What do Schnorr Signatures Mean for Fujicoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-fujicoin)
...
- Development history overview
  - [Taproot](https://fujicoinops.org/en/topics/taproot/)
  - [Schnorr signatures](https://fujicoinops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://fujicoinops.org/en/topics/tapscript/)
  - [Soft fork activation](https://fujicoinops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://fujicoin.stackexchange.com/questions/tagged/taproot)
