...
#ifndef FUJICOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define FUJICOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@fujicoin.
 *
 ...
 *
 * The chacha20-poly1305@fujicoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@fujicoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@fujicoin are relatively fast in
...
#endif // FUJICOIN_CRYPTO_CHACHA_POLY_AEAD_H
