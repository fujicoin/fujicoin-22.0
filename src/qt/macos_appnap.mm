// Copyright (c) 2011-2018 The BitcoinCore developers
    ...
    void disableAppNap()
    {
        if (!activityId)
        {
            @autoreleasepool {
                ...
                {
                    activityId = [processInfo beginActivityWithOptions: activityOptions reason:@"Temporarily disable App Nap for fujicoin-qt."];
                    [activityId retain];
                }
            }
        }
